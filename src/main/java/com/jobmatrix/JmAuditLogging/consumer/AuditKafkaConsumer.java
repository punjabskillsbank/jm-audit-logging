...
public class AuditKafkaConsumer {
    ...
    public void consume(@Payload String message, 
        ...
        try {
            ...
            switch (dto.getServiceName().toLowerCase()) {
                case "job-posting":
                    handleJobPostingAudit(dto, ack, key, partition, offset);
                    break;
                default:
    ...
    private void handleJobPostingAudit(AuditLogDTO dto, Acknowledgment ack, String key, int partition, long offset) {
    ...
    /*
    private void handleProfileManagementAudit(AuditLogDTO dto) {
        // similar logic as handleJobPostingAudit
    }

    private void handleProposalAudit(AuditLogDTO dto) {
        // similar logic as handleJobPostingAudit
    }
    */
}
