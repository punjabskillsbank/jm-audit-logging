...
class JobPostingAuditHandlerTest {
    ...
    void setUp() {
        ...
        testAuditLog = AuditLogsTestDataFactory.sampleAuditLogEntity();
    }
    ...
    void handleAudit_validDto_savesAndAcknowledges() throws Exception {
        ...
        assertEquals(EventType.JOB_POSTING_UPDATED, testAuditLog.getEventType());
        assertEquals("JobPosting", testAuditLog.getEntityName());
    }
